...
public class TransactionController {
	...
	public PageResponse<TransactionResponse> getAll(@Valid @ModelAttribute TransactionCriteria criteria, @ParameterObject Pageable pageable) {
	...
	@PostMapping
	@Operation(summary = "Create transaction", description = "Creates a new transaction. Required fields: date, amount, description, category.")
	@ApiResponses({
			@ApiResponse(responseCode = ApiInfo.HTTP_STATUS_BAD_REQUEST, description = ApiInfo.ERR_VALIDATION_FAILED, content = @Content(schema = @Schema(implementation = ApiError.class)))
