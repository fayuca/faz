...
@Schema(description = "Fields required to create or update a transaction (v2 — includes currency).")
public class TransactionRequestV2 {
	...
	@Schema(description = "ISO 4217 currency code.", implementation = Currency.class)
	private Currency currency;

	public TransactionRequestV2(
			LocalDateTime date,
			BigDecimal amount,
			String description,
